define([
    ...
    return App.module("Buyer.Bids.Closed", function(Closed, App, Backbone, Marionette, $, _) {
        this.ContainerView = Marionette.LayoutView.extend({

            template: _.template(viewClosed),
            regions: {
                        ...
                        var columns = [{
                            ...
                            formatter: _.extend({}, Backgrid.CellFormatter.prototype, {
                                fromRaw: function (rawValue, model) {
                                    return '<a class="btn-link btn--tooltip btn--asks" href="#buyer/bids/closed?bid=' +model.get('id')+ '">'+ rawValue +'</a>';
                                }
                            })
                            },
                            {
        ...
        this.onStart = function() {
            console.log("Buyer.Bids.Closed view started");
        };

        this.onStop = function() {
            console.log("Buyer.Bids.Closed view stopped");
        };
    });
});